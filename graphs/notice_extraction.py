...
class GraphState(TypedDict):
    notice_message: str
    notice_email_extract: Union[NoticeEmailExtract, None]
    escalation_text_criteria: str
    escalation_dollar_criteria: float
    requires_escalation: bool
    escalation_emails: Union[list[EmailStr], None]
    follow_ups: Union[dict[str, bool],None]
    current_follow_up: Union[str,None]
